...
def measure_locking_bar(img, mm_per_px_x=0.048531, mm_per_px_y=0.047717):                 
    ...
    biggest_cnt = sorted(contours, key=cv2.contourArea, reverse=True)
    biggest_cnt = biggest_cnt[2]
